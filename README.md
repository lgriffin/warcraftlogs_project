# WCL Analyzer v4.3.0 — TBC Edition
...
1. Download `WarcraftLogsAnalyzer-4.3.0-Setup.exe` from the [Releases](https://github.com/lgriffin/warcraftlogs_project/releases) page
